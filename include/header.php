<div id="header">
    ...
    <div class="svasta">
        ...
        <div class="tamno-sivo">

            <h1>Samuel anderson</h1>
            <div class="transition" id="download">
                <a class="link" href="">
                    <div class="overlay-content"><i class="fa fa-download fa-5x"></i>
                        <br>
        ...
        <div class="sivo">
            <h2>js generated text</h2>
            <div class="transition" id="download-portfolio">
                <a class="link" href="">
                    <div class="overlay-content"><i class="fa fa-cubes  fa-5x"></i>
                        <br>
                        <div class="overlay"></div>
                    </div>
                </a>
